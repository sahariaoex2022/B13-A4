...
### ANS:
<!-- To create and insert a new element into the DOM, we use:
...
### ANS:
<!-- Event Bubbling : Event Bubbling is a DOM event mechanism where an event starts from the target element and then bubbles up to its parent, then grandparent, and continues up to the document.
